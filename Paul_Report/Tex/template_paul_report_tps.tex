...
\chapter{A short abstract about \TR}
  ...
  \centering
    ...
    \color{blue}\frame{\includegraphics[trim=4cm 5cm 0cm 7cm, clip=true, totalheight=0.3\textwidth]{../Pictures/triumf_location.png}};
...
%   \end{tcolorbox}
  ...
  \begin{figure}[!hbtp]
  \centering
    \frame{\includegraphics[trim=15cm 1.5cm 6cm 5cm, clip=true,totalheight=.45\textwidth]{../Pictures/xe_ba.png}}%trim=leftcm bottomcm rightcm topcm, clip=true, 
  ...
  \begin{figure}[!hbtp]
    \centering
    \frame{\includegraphics[trim=25cm 11cm 9cm 10.15cm, clip=true,totalheight=.3\textwidth]{../Pictures/scintillation_process.jpg}}%trim=10cm 4cm 1cm 12cm, clip=true, 
...
\chapter{SiPM Studies}
  ...
  \quad  
    \begin{subfigure}[The filter in front of the lamp select the VUV region. Both of them attenuate the light of around 20$\%$ each.]{%
      \begin{tikzpicture}
      \node (img) {\includegraphics[width=.495\textwidth,trim=0cm 0cm 0cm 0cm, clip=true]{../Pictures/Pictures_Setup/filter_2.jpg}};
...
\chapter{Details about the setup}\label{app:setup}
  ...
  \begin{figure}[!hbtp]
      \centering
      \begin{tikzpicture}
      \node (img) {\includegraphics[width=.8\textwidth,trim=0cm 0cm 0cm 0cm, clip=true]{../Pictures/Pictures_Setup/general_picture.jpg}};
